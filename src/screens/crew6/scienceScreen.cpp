...
//Hiding Database button from ship data
...
//    });
    ...
    view_mode_selection->setOptions({tr("button", "Radar")})->setSelectionIndex(0)->setPosition(20, -20, sp::Alignment::BottomLeft)->setSize(200, 100);
